...
/**
 * This class implements the energy feature extraction algorithm.
 * 
 * @author Matthias Ring
 *
 */
public class Energy extends OneColumnFeatureExtraction {
	...
	protected double[] computeFeaturesOnColumn(double[] data) {
		return new double[] { MathUtilities.energy(data) };
	}
